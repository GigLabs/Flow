...
transaction(listingResourceID: UInt64, storefrontAddress: Address, expectedPrice: UFix64) {
    ...
    let costacos123_NFTCollection: &costacos123_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&costacos123_NFT.Collection>(from: costacos123_NFT.CollectionStoragePath) == nil {
            ...
            buyer.link<&costacos123_NFT.Collection{NonFungibleToken.CollectionPublic,costacos123_NFT.costacos123_NFTCollectionPublic}>(
        ...
        self.costacos123_NFTCollection = buyer.borrow<&costacos123_NFT.Collection{NonFungibleToken.Receiver}>(
