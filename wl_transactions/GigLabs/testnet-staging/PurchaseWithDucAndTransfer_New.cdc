...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  else if !buyer.getCapability<&giglabs_NFT.Collection{NonFungibleToken.CollectionPublic,giglabs_NFT.giglabs_NFTCollectionPublic,MetadataViews.ResolverCollection}>
      (giglabs_NFT.CollectionPublicPath)!.check() { 
