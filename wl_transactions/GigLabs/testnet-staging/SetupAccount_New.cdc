...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        else if !signer.getCapability<&giglabs_NFT.Collection{NonFungibleToken.CollectionPublic,giglabs_NFT.giglabs_NFTCollectionPublic,MetadataViews.ResolverCollection}>
