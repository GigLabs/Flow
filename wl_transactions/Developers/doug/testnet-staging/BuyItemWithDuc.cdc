...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let podunks23_NFTCollection: &podunks23_NFT.Collection
    ...
    prepare(
        ...
        self.podunks23_NFTCollection = buyer.storage.borrow<&podunks23_NFT.Collection>(
            from: podunks23_NFT.CollectionStoragePath
    ...
    execute {
        ...
        self.podunks23_NFTCollection.deposit(token: <-item)
