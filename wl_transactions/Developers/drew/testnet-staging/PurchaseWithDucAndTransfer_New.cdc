...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  else if !buyer.getCapability<&drewdapper_NFT.Collection{NonFungibleToken.CollectionPublic,drewdapper_NFT.drewdapper_NFTCollectionPublic,MetadataViews.ResolverCollection}>
