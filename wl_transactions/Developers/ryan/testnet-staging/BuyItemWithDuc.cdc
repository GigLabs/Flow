...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let ryandapper_NFTCollection: &ryandapper_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&ryandapper_NFT.Collection>(from: ryandapper_NFT.CollectionStoragePath) == nil {
            ...
            buyer.link<&ryandapper_NFT.Collection{NonFungibleToken.CollectionPublic,ryandapper_NFT.ryandapper_NFTCollectionPublic}>(
        ...
        self.ryandapper_NFTCollection = buyer.borrow<&ryandapper_NFT.Collection{NonFungibleToken.Receiver}>(
