...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let DapPen_NFTCollection: &DapPen_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&DapPen_NFT.Collection>(from: DapPen_NFT.CollectionStoragePath) == nil {
            ...
            buyer.link<&DapPen_NFT.Collection{NonFungibleToken.CollectionPublic,DapPen_NFT.DapPen_NFTCollectionPublic}>(
        ...
        self.DapPen_NFTCollection = buyer.borrow<&DapPen_NFT.Collection{NonFungibleToken.Receiver}>(
            from: DapPen_NFT.CollectionStoragePath
    ...
    execute {
        ...
        self.DapPen_NFTCollection.deposit(token: <-item)
