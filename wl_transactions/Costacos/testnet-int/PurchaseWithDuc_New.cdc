...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  prepare(gig: AuthAccount, dapper: AuthAccount, buyer: AuthAccount) {
    ...
    else if !buyer.getCapability<&costacos123_NFT.Collection{NonFungibleToken.CollectionPublic,costacos123_NFT.costacos123_NFTCollectionPublic,MetadataViews.ResolverCollection}>
