...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Costacos_NFT.Collection>(from: Costacos_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&Costacos_NFT.Collection{NonFungibleToken.CollectionPublic,Costacos_NFT.Costacos_NFTCollectionPublic,MetadataViews.ResolverCollection}>(
        ...
        else if !signer.getCapability<&Costacos_NFT.Collection{NonFungibleToken.CollectionPublic,Costacos_NFT.Costacos_NFTCollectionPublic,MetadataViews.ResolverCollection}>
            (Costacos_NFT.CollectionPublicPath)!.check() { 
