...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  else if !buyer.getCapability<&Costacos_NFT.Collection{NonFungibleToken.CollectionPublic,Costacos_NFT.Costacos_NFTCollectionPublic,MetadataViews.ResolverCollection}>
