...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  else if !buyer.getCapability<&Birdieland_NFT.Collection{NonFungibleToken.CollectionPublic,Birdieland_NFT.Birdieland_NFTCollectionPublic,MetadataViews.ResolverCollection}>
      (Birdieland_NFT.CollectionPublicPath)!.check() { 
