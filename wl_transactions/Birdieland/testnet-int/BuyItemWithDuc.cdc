...
transaction(listingResourceID: UInt64, storefrontAddress: Address, expectedPrice: UFix64) {
    ...
    let izon_NFTCollection: &izon_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        self.izon_NFTCollection = buyer.borrow<&izon_NFT.Collection{NonFungibleToken.Receiver}>(
