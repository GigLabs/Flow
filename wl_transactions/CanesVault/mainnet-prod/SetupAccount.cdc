...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Canes_Vault_NFT.Collection>(from: Canes_Vault_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&Canes_Vault_NFT.Collection{NonFungibleToken.CollectionPublic,Canes_Vault_NFT.Canes_Vault_NFTCollectionPublic,MetadataViews.ResolverCollection}>(
        ...
        else if (signer.getCapability<&Canes_Vault_NFT.Collection{NonFungibleToken.CollectionPublic,Canes_Vault_NFT.Canes_Vault_NFTCollectionPublic,MetadataViews.ResolverCollection}>(Canes_Vault_NFT.CollectionPublicPath).borrow() == nil) {
