...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        else if !signer.getCapability<&Canes_Vault_NFT.Collection{NonFungibleToken.CollectionPublic,Canes_Vault_NFT.Canes_Vault_NFTCollectionPublic,MetadataViews.ResolverCollection}>
            (Canes_Vault_NFT.CollectionPublicPath)!.check() { 
