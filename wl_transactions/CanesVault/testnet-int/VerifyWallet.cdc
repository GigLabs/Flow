...
transaction(verificationToken: String) {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Canes_Vault_Int_NFT.Collection>(from: Canes_Vault_Int_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&Canes_Vault_Int_NFT.Collection{Canes_Vault_Int_NFT.Canes_Vault_Int_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(
