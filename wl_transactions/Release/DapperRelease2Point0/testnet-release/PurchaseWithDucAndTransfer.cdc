...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  let buyerNFTCollection: &AnyResource{dapperrelease2point0_NFT.dapperrelease2point0_NFTCollectionPublic}
  ...
  prepare(gig: AuthAccount, dapper: AuthAccount, buyer: AuthAccount) {
    ...
    // withdraw NFT
    let gigNftProvider = gig.borrow<&dapperrelease2point0_NFT.Collection>(from: dapperrelease2point0_NFT.CollectionStoragePath)
    ...
    .getCapability(dapperrelease2point0_NFT.CollectionPublicPath)!
    .borrow<&{dapperrelease2point0_NFT.dapperrelease2point0_NFTCollectionPublic}>()!
  }
  pre {
