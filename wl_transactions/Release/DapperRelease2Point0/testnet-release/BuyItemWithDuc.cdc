...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let dapperrelease2point0_NFTCollection: &dapperrelease2point0_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&dapperrelease2point0_NFT.Collection>(from: dapperrelease2point0_NFT.CollectionStoragePath) == nil {
            ...
            buyer.link<&dapperrelease2point0_NFT.Collection{NonFungibleToken.CollectionPublic,dapperrelease2point0_NFT.dapperrelease2point0_NFTCollectionPublic}>(
        ...
        self.dapperrelease2point0_NFTCollection = buyer.borrow<&dapperrelease2point0_NFT.Collection{NonFungibleToken.Receiver}>(
