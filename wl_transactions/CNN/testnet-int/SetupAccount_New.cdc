...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        else if !signer.getCapability<&CNN_INT_NFT.Collection{NonFungibleToken.CollectionPublic,CNN_INT_NFT.CNN_INT_NFTCollectionPublic,MetadataViews.ResolverCollection}>
            (CNN_INT_NFT.CollectionPublicPath)!.check() { 
