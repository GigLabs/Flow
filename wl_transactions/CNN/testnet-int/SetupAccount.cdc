...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&CNN_INT_NFT.Collection>(from: CNN_INT_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&CNN_INT_NFT.Collection{NonFungibleToken.CollectionPublic,CNN_INT_NFT.CNN_INT_NFTCollectionPublic,MetadataViews.ResolverCollection}>(
        ...
        else if (signer.getCapability<&CNN_INT_NFT.Collection{NonFungibleToken.CollectionPublic,CNN_INT_NFT.CNN_INT_NFTCollectionPublic,MetadataViews.ResolverCollection}>(CNN_INT_NFT.CollectionPublicPath).borrow() == nil) {
