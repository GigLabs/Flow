...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&RaceDay_NFT.Collection>(from: RaceDay_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&RaceDay_NFT.Collection{NonFungibleToken.CollectionPublic,RaceDay_NFT.RaceDay_NFTCollectionPublic,MetadataViews.ResolverCollection}>(
        ...
        else if !signer.getCapability<&RaceDay_NFT.Collection{NonFungibleToken.CollectionPublic,RaceDay_NFT.RaceDay_NFTCollectionPublic,MetadataViews.ResolverCollection}>
            (RaceDay_NFT.CollectionPublicPath)!.check() { 
