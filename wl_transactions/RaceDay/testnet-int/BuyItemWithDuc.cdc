...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let RaceDay_NFTCollection: &RaceDay_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        self.RaceDay_NFTCollection = buyer.borrow<&RaceDay_NFT.Collection{NonFungibleToken.Receiver}>(
            from: RaceDay_NFT.CollectionStoragePath
    ...
    execute {
        ...
        self.RaceDay_NFTCollection.deposit(token: <-item)
