...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let UFC_NFTCollection: &UFC_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&UFC_NFT.Collection>(from: UFC_NFT.CollectionStoragePath) == nil {
            ...
            buyer.link<&UFC_NFT.Collection{NonFungibleToken.CollectionPublic,UFC_NFT.UFC_NFTCollectionPublic}>(
        ...
        self.UFC_NFTCollection = buyer.borrow<&UFC_NFT.Collection{NonFungibleToken.Receiver}>(
