...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        else if !signer.getCapability<&ufcInt_NFT.Collection{NonFungibleToken.CollectionPublic,ufcInt_NFT.ufcInt_NFTCollectionPublic,MetadataViews.ResolverCollection}>
