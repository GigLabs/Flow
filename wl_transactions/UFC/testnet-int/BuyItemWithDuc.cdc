...
transaction(listingResourceID: UInt64, storefrontAddress: Address, expectedPrice: UFix64) {
    ...
    let ufcInt_NFTCollection: &ufcInt_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        self.ufcInt_NFTCollection = buyer.borrow<&ufcInt_NFT.Collection{NonFungibleToken.Receiver}>(
            from: ufcInt_NFT.CollectionStoragePath
    ...
    execute {
        ...
        self.ufcInt_NFTCollection.deposit(token: <-item)
