...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        else if !signer.getCapability<&AtlantaHawks_NFT.Collection{NonFungibleToken.CollectionPublic,AtlantaHawks_NFT.AtlantaHawks_NFTCollectionPublic,MetadataViews.ResolverCollection}>
