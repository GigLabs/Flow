...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let BreakingT_NFTCollection: &BreakingT_NFT.Collection
    ...
    prepare(
        ...
        if buyer.storage.borrow<&BreakingT_NFT.Collection>(from: BreakingT_NFT.CollectionStoragePath) == nil {

            // Create a new empty collection and save it to the account
            buyer.storage.save(<-BreakingT_NFT.createEmptyCollection(nftType: Type<@BreakingT_NFT.NFT>()), to: BreakingT_NFT.CollectionStoragePath)

            // create a public capability for the collection
            buyer.capabilities.unpublish(BreakingT_NFT.CollectionPublicPath)
            let collectionCap = buyer.capabilities.storage.issue<&BreakingT_NFT.Collection>(BreakingT_NFT.CollectionStoragePath)
            buyer.capabilities.publish(collectionCap, at: BreakingT_NFT.CollectionPublicPath)
        }
        ...
        self.BreakingT_NFTCollection = buyer.storage.borrow<&BreakingT_NFT.Collection>(
