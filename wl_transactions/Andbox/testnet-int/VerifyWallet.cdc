...
transaction(verificationToken: String) {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&AndBoxINT_NFT.Collection>(from: AndBoxINT_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&AndBoxINT_NFT.Collection{AndBoxINT_NFT.AndBoxINT_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(
