...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  else if !buyer.getCapability<&Andbox_NFT.Collection{NonFungibleToken.CollectionPublic,Andbox_NFT.Andbox_NFTCollectionPublic,MetadataViews.ResolverCollection}>
