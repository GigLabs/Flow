...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Andbox_NFT.Collection>(from: Andbox_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&Andbox_NFT.Collection{NonFungibleToken.CollectionPublic,Andbox_NFT.Andbox_NFTCollectionPublic,MetadataViews.ResolverCollection}>(
        ...
        else if !signer.getCapability<&Andbox_NFT.Collection{NonFungibleToken.CollectionPublic,Andbox_NFT.Andbox_NFTCollectionPublic,MetadataViews.ResolverCollection}>
            (Andbox_NFT.CollectionPublicPath)!.check() { 
