...
transaction(storefrontAddress: Address, listingResourceID: UInt64, expectedPrice: UFix64) {
    ...
    let Dapper_NFTCollection: &Dapper_NFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&Dapper_NFT.Collection>(from: Dapper_NFT.CollectionStoragePath) == nil {
            ...
            buyer.link<&Dapper_NFT.Collection{NonFungibleToken.CollectionPublic,Dapper_NFT.Dapper_NFTCollectionPublic}>(
        ...
        self.Dapper_NFTCollection = buyer.borrow<&Dapper_NFT.Collection{NonFungibleToken.Receiver}>(
