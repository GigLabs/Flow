...
transaction() {
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Cimelio_NFT.Collection>(from: Cimelio_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&Cimelio_NFT.Collection{NonFungibleToken.CollectionPublic,Cimelio_NFT.Cimelio_NFTCollectionPublic,MetadataViews.ResolverCollection}>(
        ...
        else if !signer.getCapability<&Cimelio_NFT.Collection{NonFungibleToken.CollectionPublic,Cimelio_NFT.Cimelio_NFTCollectionPublic,MetadataViews.ResolverCollection}>
