...
transaction(sellerAddress: Address, nftIDs: [UInt64], price: UFix64, metadata: {String: String}) {
  ...
  let buyerNFTCollection: &AnyResource{cimelio_NFT.cimelio_NFTCollectionPublic}
  ...
  // Metadata Resolver interface for the Metadata Standard views
    ...
    // withdraw NFT
    let gigNftProvider = gig.borrow<&cimelio_NFT.Collection>(from: cimelio_NFT.CollectionStoragePath)
